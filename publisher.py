...
async def publish_deal(text: str, media_path: str | None = None, reply_markup = None):
    ...
    try:
        ...
        if media_path and not is_long_text:
            ...
            await bot.send_photo(chat_id=TARGET_CHANNEL, photo=photo, caption=text, parse_mode="HTML", reply_markup=reply_markup)
        else:
            ...
            await bot.send_message(chat_id=TARGET_CHANNEL, text=text, disable_web_page_preview=True, parse_mode="HTML", reply_markup=reply_markup)
